...
Lectures will be held in-person at the regularly-scheduled time and place. Attendance is optional and is not required to earn 100% in the course. Slides/notes will be posted, and classes will be podcasted and posted online for remote viewing. In-class participation provides an opportunity to earn extra credit; see {ref}`Participation` for details.

Lectures for both 150A/250A will be delivered together on
`Tue/Thu, 12:30PM - 1:50PM`, at [JEANN](https://map.concept3d.com/?id=1005#!s/JEANN_Main?ct/18312)
...
The course does not closely follow a particular text. Nevertheless, the following texts (though not required) may be useful as general references. Most of these are freely available (except Russell & Norvig).
...
For in class questions, we’re going to use [webclicker.web.app](https://webclicker.web.app/). Please login using your UCSD Google Email address (‘Sign in with Google’) and register for this class using course registration code. If you don't have a *UCSD Google Email* (Global Exchange and UCEAP Students), you may use a personal Google account. Enter your TSN (usually starting with 2) in the Student Identifier field.

The course registration code is `VDPKNJ`.
...
:::{important}
The two in-person, self-scheduled tests will happen in `Week 5` and `Week 9`.
:::
...
- Final Project (group): A deeper, open-ended assignment that serves as the take-home final for the class. You will form groups, select a dataset and problem of interest, and apply methods from the course.
<!-- The project is due on Gradescope during the **official final exam window**.  -->
Project guidelines and instructions will be released during the quarter. See the [schedule](schedule.md) for project deadlines.

Please note, there is no grace period for project submissions. We will not accept any late submissions for the projects.

### Participation

This quarter, we will use in-class questions (using {ref}`Webclicker`) and surveys to provide feedback and encourage participation. These are graded for completion, not correctness.

Participation is optional and can earn you up to **2 percentage points of extra credit** toward your final course grade. Each class with Webclicker questions and each course survey counts as one participation opportunity. For an in-class participation opportunity, responding to at least one Webclicker question earns credit for that class. Extra credit is proportional to the number of participation opportunities you complete.

:::{caution}
Submitting responses to in-class polls when not physically present, or responding when specifically instructed not to do so, is treated as a misrepresentation of participation and an academic integrity violation. This may result in sanctions, including being reported to the Academic Integrity Office.
:::

### Tests

There will be two in-person, self-scheduled tests. Test 1 will be in **Week 5** and Test 2 will be in **Week 9**. Test 1 covers all material through Week 4 and Test 2 covers all material through Week 8.
...
To make sure you have access to the test questions, you need to be enrolled in PrairieLearn course instance: [Enrollment Link](https://us.prairielearn.com/pl/course_instance/233956/join/YCMENQC7JN).

To schedule the test, first make sure you self-enroll in PrairieTest: [Enrollment Link](https://us.prairietest.com/pt/student/course/24717/enroll/048599788982)
...
More information about testing policies and procedures can be found on the [TTC's website](https://tritontesting.ucsd.edu/computer-based-testing/students/index.html). For the fastest assistance with scheduling questions, students should contact the Triton Testing Center directly at [tritontesting@ucsd.edu](mailto:tritontesting@ucsd.edu).
...
**Make-up Test**
You may take an optional make-up test in **Week 10**. The make-up test is cumulative and covers all material through Week 9. If your make-up test score is higher than the lower of your Test 1 or Test 2 scores, it will replace that lower score. Taking the make-up test is **optional**.

A lower score on the make-up test will not reduce your grade.
...
:::{note} From TTC:
Registration for make-up tests will open on the Friday before the start of the testing window. Once the registration window opens for the make-ups, if students have trouble finding a spot, they can email us at tritontesting@ucsd.edu.
:::
...
In addition, you can earn up to **2 percentage points of extra credit** through participation. See {ref}`Participation` for details.

### Grading Scale

The standard grading scale below is the starting point, but after all scores are in a clustering algorithm will set the final cutoffs for each letter grade in each section (150A or 250A). These cutoffs can only **move down**, never up. For example, the A cutoff will never exceed 94%.
...
Tests must be taken during their scheduled testing windows. We do not offer individual make-up tests outside the scheduled testing windows. The optional Week 10 make-up test described above is the only standard opportunity to replace a missed or lower test score. Beyond the 24hr grace period, late homework will not be accepted. There is no grace period for project submissions. If you have a serious illness or an emergency, please talk to the instructor about it.
...
Minor illnesses are common. The 24-hour late window, self-scheduled tests and make-up test are designed to absorb routine disruptions without individual exceptions. For serious illness or an extended medical issue, contact the instructor and provide documentation so we can coordinate accommodations.
